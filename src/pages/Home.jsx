		...
		<>
			...
			<div className="min-h-screen bg-black text-white relative overflow-hidden font-['Bebas_Neue']">
				...
				<div className="relative z-30 max-w-7xl mx-auto">
					{/* Hero Section */}
					<section className="min-h-screen flex items-center px-4 sm:px-6 md:px-8 lg:px-16 relative">
					...
					<motion.div
						...
						transition={{ duration: 1, ease: "easeOut" }}
						viewport={{ once: true }}
						className="w-full h-px bg-gradient-to-r from-transparent via-purple-400 to-transparent opacity-30 mx-4 sm:mx-6 md:mx-8 lg:mx-16"
					></motion.div>
